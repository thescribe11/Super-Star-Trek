...
def test_enterprise() -> None:
    ...
    SST.impulse_move(ent, math.inf, 0, 2)
    ...
    SST.impulse_move(ent, math.inf, 0, -4)
    ...
    SST.impulse_move(ent, math.inf, 0, 20)
    print(f'{ent.ghoriz=}')
